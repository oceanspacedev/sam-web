    ...
    */
    ...
    'resources' => [
        ...
        'manage' => [
            ...
            \App\Filament\Resources\BadanUsahas\BadanUsahaResource::class => [
                'viewAny', 'view', 'create', 'update', 'delete', 'deleteAny',
                'restore', 'forceDelete', 'forceDeleteAny', 'restoreAny',
            ],
            \App\Filament\Resources\Divisions\DivisionResource::class => [
                'viewAny', 'view', 'create', 'update', 'delete', 'deleteAny',
                'restore', 'forceDelete', 'forceDeleteAny', 'restoreAny',
            ],
            \App\Filament\Resources\Regions\RegionResource::class => [
                'viewAny', 'view', 'create', 'update', 'delete', 'deleteAny',
                'restore', 'forceDelete', 'forceDeleteAny', 'restoreAny',
            ],
            \App\Filament\Resources\Clusters\ClusterResource::class => [
                'viewAny', 'view', 'create', 'update', 'delete', 'deleteAny',
                'restore', 'forceDelete', 'forceDeleteAny', 'restoreAny',
            ],
