...
class EnvExampleLaravel12Test extends TestCase
{
    public function test_env_example_only_contains_env_keys_this_codebase_reads(): void
    {
        ...
        $requiredKeys = [
            ...
            'WHATSAPP_GATEWAY_FALLBACK_PROVIDER',
            'WHATSAPP_GATEWAY_FALLBACK_ENABLED',
            'WHATSAPP_GATEWAY_WAHA_BASE_URL',
            'WHATSAPP_GATEWAY_WAHA_API_KEY',
            'WHATSAPP_GATEWAY_WAHA_SESSION',
            'WHATSAPP_GATEWAY_FONNTE_ENDPOINT',
            'WHATSAPP_GATEWAY_FONNTE_TOKEN',
            'WHATSAPP_GATEWAY_COUNTRY_CODE',
